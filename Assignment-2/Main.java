public class Main {
    ...
    public static void main(String[] args){
        ...
        assertEquals(myTree.toString(),"└── 10\n" +
                ...
                "    │   ├── 30, 33\t(p:12)\n" +
                "    │   ├── 55, 60\t(p:12)\n" +
                "    │   └── 120, 150, 200, 210\t(p:12)\n");

        myTree.insert(500);
        assertEquals(myTree.toString(),"└── 10, 40\n" +
                "    ├── 2, 5, 8\t(p:10)\n" +
                "    │   ├── 0, 1, 2\t(p:2)\n" +
                "    │   ├── 3, 4\t(p:2)\n" +
                "    │   ├── 6, 7\t(p:2)\n" +
        ...
        assertEquals(myTree.toString(),"└── 10, 40\n" +
                ...
                "    │   ├── 210, 500\t(p:100)\n" +
                "    │   ├── 1100, 1200\t(p:100)\n" +
                "    │   └── 1400, 1500, 1600, 1700\t(p:100)\n");

        myTree.insert(1800);
        assertEquals(myTree.toString(),"└── 10, 40, 1000\n" +
                "    ├── 2, 5, 8\t(p:10)\n" +
                "    │   ├── 0, 1, 2\t(p:2)\n" +
                "    │   ├── 3, 4\t(p:2)\n" +
                "    │   ├── 6, 7\t(p:2)\n" +
        ...
        assertEquals(myTree.printPath(200),"10 -> 40 -> 100 -> 200");
        assertEquals(myTree.printPath(1300),"10 -> 40 -> 1000 -> 1300");
        assertEquals(myTree.printPath(1800),"10 -> 40 -> 1000 -> 1300 -> 1600 -> 1700 -> 1800");
        assertEquals(myTree.printPath(120),"10 -> 40 -> 100 -> 120");
        assertEquals(myTree.printPath(500),"10 -> 40 -> 100 -> 200 -> 210 -> 500");
        assertEquals(myTree.printPath(30),"10 -> 12 -> 24 -> 30");
        assertEquals(myTree.printPath(3000),"10 -> 40 -> 1000 -> 1300 -> 1600 -> 1700 -> 1800 -> Null");
        BTree<Integer> other = new BTree<>(6);
        assertEquals(other.printPath(30),"Null");
        other.insert(10);
        other.insert(20);
        other.insert(30);
        other.insert(40);
