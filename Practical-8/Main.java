...
public class Main {
    ...
    {
        startSuite("Memory Sort Test");
        Memory memory = new Memory(10);

        assertEquals(memory.isEmpty(),true);

        memory.add(22);
        assertEquals(memory.currentSize,1);

        memory.add(12);
        assertEquals(memory.currentSize,2);

        memory.add(1);
        assertEquals(memory.currentSize,3);

        memory.add(-1);
        assertEquals(memory.currentSize,4);

        memory.add(0);
        assertEquals(memory.currentSize,5);

        memory.add(7);
        assertEquals(memory.currentSize,6);

        memory.add(5);
        assertEquals(memory.currentSize,7);

        memory.add(17);
        assertEquals(memory.currentSize,8);

        memory.add(3);
        assertEquals(memory.currentSize,9);

        memory.add(99);
        assertEquals(memory.currentSize,10);

        memory.add(5);
        assertEquals(memory.currentSize,10);

        assertEquals(memory.getData()[0],22);

        memory.quickSort();

        assertEquals(memory.getData()[0],-1);

        memory.quickSort();

        assertEquals(memory.getData()[0],-1);

        endSuite("Memory Sort Test");
